...
public class CitySearchAdapter extends ArrayAdapter<SearchInfo> {
	...
	public CitySearchAdapter(Context context, int layoutResourceId,
			ArrayList<SearchInfo> searchList) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (row == null) {
			...
			holder.txtSearchName = (CheckedTextView) row
					.findViewById(R.id.searchitemid);
